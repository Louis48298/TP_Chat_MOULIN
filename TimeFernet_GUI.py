...
class TimeFernet_GUI(Fernet_GUI.Fernet_GUI):
    ...
    def encrypt(self,message):
        ...
        f = Fernet(self._key)
        encrypted = f.encrypt_at_time(message, time.time())
        iv = os.urandom(16)
        return (iv, encrypted)
    ...
    def decrypt(self,iv,encrypted):
        ...
        return f.decrypt_at_time(decrypted, time.time(), iv)
